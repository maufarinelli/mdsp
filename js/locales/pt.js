    ...
    angular.module('i18n')
        .factory('ptText', function() {
            return {
                ...
                'home.phrase4': 'Você quer um <b>praia linda e bem tranquila</b>? Tem! Você quer uma <b>praia mais agitada</b>, com mais badalação? Tem também. Prefere <b>caminhar a beira do mar</b>? Ou dar uma <b>bom mergulho e ficar boiando</b> por horas? Morro de São Paulo é um <b>lugar para todos os gostos</b>. <a href="#">Veja mais</a>',
                'home.phrase5': 'A <b>vida noturna</b> também é <b>variada</b>. Tem agitação com <b>casas noturnas</b> ou <b>restaurantes com clima romântico</b> e música ao vivo. Bares para tomar uma <b>cerveja gelada com a galera</b> ou <b>restaurantes para familias com crianças</b>. Restaurantes de frente para o mar ou no meio da vila. <b>Tem de tudo mesmo</b>. Aliás, <b>gastronomia é um dos pontos fortes</b> de Morro de São Paulo. <a href="#">Saiba mais</a>',
                'home.phrase6': 'Além das 4 praias que você deve conhecer, Morro de São Paulo possui <b>diversos passeios</b> e <b>atividades</b> para se fazer. <b>Subir no morro do Farol</b> para admirar a vista e <b>descer pela tiroleza</b>, pegar um passeio de <b>lancha em volta de toda a Ilha</b>, <b>mergulho</b> ou <b>snorkeling</b>, <b>pôr-do-sol do forte</b>, <b>surf</b> na primeira praia e muita mais. <a href="#">Confira</a>',
                'home.phrase7': 'Morro de São Paulo possui <b>pousadas e hotéis</b> que agradam <b>todos os gostos</b>. Desde <b>pousadas tranquilas a beira mar</b>, passando por <b>simples pousadas</b> e <b>albergues</b> no vilarejo, até mesmo <b>hotéis bem sofisticados</b>. Morro de São Paulo tem o tipo de hospedagem que você está procurando. <a href="#">Saiba mais</a>',
